...
const page = () => {
    ...
    return (
        <main className="w-full min-h-screen pb-20 flex flex-col items-center">
            ...
            <section className="w-full max-w-7xl pt-10 flex justify-center max-lg:flex-col gap-10 px-10">
            {/* Form Section */}
            <div className="w-full max-w-md bg-black/50 border border-[#00bfff] p-8 rounded-3xl shadow-[0_0_20px_5px_rgba(0,191,255,0.2)] backdrop-blur-md">
            ...
            {/* Info Section */}
            <div className="w-full max-w-md bg-[#0a0a0a]/80 border border-gray-700 p-8 rounded-3xl shadow-lg backdrop-blur-md flex flex-col justify-between h-full">
                <div>
