...
const TeamCard = ({ name, role, fb, linkedin, mail }: TeamCardProps) => {
    return (
        <div className="relative overflow-hidden w-full max-w-80 max-h-85 rounded-4xl flex flex-col items-center bg-black border-white border py-4 shadow-[0_0_9px_4px_rgba(0,191,255,0.8)] backdrop-blur-lg group">
            ...
            <div className="relative z-10 w-full flex flex-col items-center pointer-events-none">
                ...
                <h4 className="text-gray-300 mb-4 pointer-events-auto">{role}</h4>
